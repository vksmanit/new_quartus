...
#QUARTUS17:=/opt/quartus/intelFPGA_lite/17.1
QUARTUS17:=$(HOME)/intelFPGA_lite/17.1

# You can specify this from command-line everytime. Better to change the name here.
#SOPCINFO:=platform01.sopcinfo
SOPCINFO:=design01.sopcinfo

SOFTWARE_PROJECT_NAME:=my_software
NIOS_CMD_SHELL_SCRIPT:=$(QUARTUS17)/nios2eds/nios2_command_shell.sh
VSIM_BIN_DIR__:=$(QUARTUS17)/modelsim_ase/linuxaloem
